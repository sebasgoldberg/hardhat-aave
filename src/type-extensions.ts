...
export const NETWORK_NAMES = [ 'avalanche-mainnet', 'custom-network' ] as const

type NetworkNameTuple = typeof NETWORK_NAMES
...
export type ContractAddressesByNetwork = {
  [key in NetworkName]: IContractAddresses
}
...
declare module "hardhat/types/config" {
  ...
  export interface HardhatUserConfig {
    aave?: {
      contractAddressByNetwork?: ContractAddressesByNetwork
    }
  }
